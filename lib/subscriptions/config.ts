...
export const SUBSCRIPTION_PLANS: Record<SubscriptionPlanKey, SubscriptionPlanConfig> = {
  monitor: {
    key: "monitor",
    displayName: "Website Refresh + Hosting",
    description:
      "Lighter monthly redesign support with hosting for businesses that want a clearer site without full hands-on growth work every month.",
    monthlyPositioning: "Lighter monthly website support with hosting.",
    shortSummary: "Hosting, homepage refresh direction, and light monthly updates.",
    bestFit:
      "Businesses that want hosting and practical updates without heavier monthly redesign work.",
    featureList: [
      "Hosting included",
    ...
    ctaLabel: "Choose Refresh",
    downgradeCtaLabel: "Switch to Refresh",
  },
  growth: {
    key: "growth",
    displayName: "Website Growth + Hosting",
    description:
      "The core monthly plan: redesign support, hosting, and steady page/content improvements without a huge one-time project.",
    monthlyPositioning: "Steady monthly redesign progress with hosting included.",
    shortSummary: "Redesign, host, and keep improving on a practical monthly cadence.",
    bestFit:
      "Service businesses that want a stronger website and ongoing improvements month to month.",
    featureList: [
  ...
  managed: {
    key: "managed",
    displayName: "Managed Website + Growth",
    description:
      "Higher-touch monthly website support for businesses that want deeper redesign work and more done-for-you updates.",
    monthlyPositioning: "Higher-touch monthly redesign and website support.",
    shortSummary: "Deeper redesign support with priority roadmap reviews.",
    bestFit:
      "Businesses that want more hands-on website work each month.",
    featureList: [
      "Everything in Growth",
      "Higher-touch redesign support",
      "Deeper page and content work",
      "Priority roadmap reviews",
      "GEO support available",
      "Cancel anytime",
    ],
...
export const PLAN_COMPARISON_ROWS: PlanComparisonRow[] = [
  ...
  {
    key: "homepage_refresh",
    label: "Homepage redesign direction",
    values: { monitor: "Yes", growth: "Yes", managed: "Yes" },
  },
  {
    key: "monthly_updates",
    label: "Monthly website updates",
    values: { monitor: "Light", growth: "Yes", managed: "Higher-touch" },
  },
  {
    key: "cta_focus",
    label: "CTA / conversion focus",
    values: { monitor: "Basic", growth: "Yes", managed: "Yes" },
  },
  {
    key: "content_iterations",
    label: "Page & content iterations",
    values: { monitor: "Limited", growth: "Yes", managed: "Deeper" },
  },
  {
  ...
  {
    key: "geo_support",
    label: "GEO / AI visibility support",
    values: { monitor: "Optional", growth: "Optional", managed: "Available" },
  },
  {
    key: "cancel_anytime",
...
export const DOWNGRADE_PATHS: DowngradePath[] = [
  {
    ...
    confirmationCopy:
      "Your plan will switch to Website Growth + Hosting on your next billing date.",
  ...
  },
  {
    ...
    targetPlan: "monitor",
    effectiveTiming: "next_billing_cycle",
    customerCopy: "Need lighter support? Keep hosting and simpler monthly updates with Refresh.",
    confirmationCopy:
      "Your plan will switch to Website Refresh + Hosting on your next billing date.",
    adminEvent: "downgrade_completed",
    analyticsEvent: "downgrade_completed",
  },
];
...
export const SAVE_OFFERS: Record<SaveOfferType, SaveOfferConfig> = {
  downgrade_monitor: {
    ...
    label: "Switch to Refresh",
    title: "Need a lighter option?",
    description:
      "Website Refresh + Hosting keeps hosting and simpler monthly updates without the heavier support level.",
    ctaLabel: "Switch to Refresh",
    targetPlan: "monitor",
  },
  downgrade_growth: {
